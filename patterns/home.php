                ...
                <div class="flex-1 space-y-4 bg-radial-gradient-primary">
                    <div class="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                        <div class="lg:p-14 p-4 content-center space-y-2 gs_reveal gs_reveal_fromLeft">
                            <h1 class="primary color-spectra-yellow">Preparing Indonesia’s Future Force</h1>
                            <p class="primary color-muted pb-4">by consulting and outsourcing data talents</p>
                            <button class="btn-white text-primary rounded px-4 py-2">Find Out More</button>
                        </div>
    ...
    <div class="bg-4 m-0 lg:block hidden btn-navigation-group bg-navbar " id="btn-nav-group">
        <div class="relative px-8 lg:px-14 ">
            <div class="grid gap-x-20 grid-cols-4">
                <a href="#what-we-do" class="focus:outline-none btn-navigation-transparent text-center text-primary px-4 py-2">
                    What We Do
                </a>
                <a href="#testimonial" class="focus:outline-none btn-navigation-transparent text-center text-primary px-4 py-2">
                    Testimonial
                </a>
                <a href="#as-seen-on" class="focus:outline-none btn-navigation-transparent text-center text-primary px-4 py-2">
                    As Seen On
                </a>
                <a href="#gallery" class="focus:outline-none btn-navigation-transparent text-center text-primary px-4 py-2">
                    Gallery
                </a>
            </div>
        </div>
                ...
                <div class="flex-1 space-y-4">
                    <div class="grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                        <div class="content-end space-y-2 pb-8 gs_reveal gs_reveal_fromLeft">
                            <h3 class="primary text-black">What We Do</h3>
                            <p class="primary regular text-black">Deliver a cutting edge solution through adopting a framework which focuses on talent development, artificial & business intelligence, and technology development.</p>
                        </div>
                    ...
                    <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                        <div class="content-center space-y-2 bg-radial-gradient-primary">
                            ...
                            <div class="flex space-x-4">
                                <div class="space-y-2 pb-8 pl-14 gs_reveal">
                                    <h3 class="primary color-spectra-yellow">Data Fellowship</h3>
                                    <p class="primary regular color-muted">Are you ready to challenge yourself to be the best #DataHeroes and get hired as Data Engineer? Click here to find out more about our most awaited bootcamp.</p>
                                </div>
                        ...
                        <div class="grid justify-center">
                            <div class="bg-spectra-yellow">
                                ...
                                <div class="flex space-x-4 pt-4">
                                    <div class="space-y-2 pb-8 pl-14 gs_reveal gs_reveal_fromRight">
                                        <h3 class="primary text-white">Corporate Training</h3>
                                        <p class="primary regular text-black">Build the whole big data and analytics capability needed by the great talent of an organization through solid fundamental concepts, real data projects.</p>
                                    </div>
                                    <div class="pr-14 flex items-center lg:items-start">
                            ...
                            <div class="bg-3">
                                ...
                                <div class="flex space-x-4 pt-4">
                                    <div class="space-y-2 pb-8 pl-14 gs_reveal gs_reveal_fromRight">
                                        <h3 class="primary text-black">Managed Service</h3>
                                        <p class="primary regular text-black">Through this service, we are focused on providing great executing through global standards data talents.</p>
                                    </div>
                                    <div class="pr-14 flex items-center lg:items-start">
                                        <button class="btn-primary text-primary rounded w-14 h-14 btn-rotate-45 rounded-full hover:bg-white hover:text-black">
                                            <i class="fa fa-arrow-right icon-large"></i>
                ...
                <div class="flex-1 space-y-4">
                    <div class="grid gap-4">
                        <div class=" content-center space-y-2 gs_reveal gs_reveal_fromLeft">
                            <h3 class="primary text-black">Testimonial</h3>
                            <p class="primary regular text-black">Let's hear from our partners!</p>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="content-start lg:content-center lg:col-span-3 sm:col-span-1">
                                            <div class="lg:relative lg:-left-20 gs_reveal">
                                                <div class="bg-white p-4 rounded m-2">
                                                    <p class="primary regular text-black">IYKRA is highly committed to achieving success in collaborations in the field of Data Visualization and Data Engineering, thus ensuring partners receive exceptional and high-quality outcomes.</p>
                                                </div>
                                                <div class="p-4 m-2 lg:mb-0 lg:pb-0 lg:relative lg:left-20">
                                                    <p class="primary regular"><b>Darman Susanto S.</b></p>
                                                    <p class="primary regular">Bank Negara Indonesia</p>
                                                    <p class="primary regular">Team Lead - Information Delivery Department - Data Management and Analytics Division</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="h-full space-y-4 bg-spectra-yellow">
                                    <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 h-full">
                                        ...
                                        <div class="content-start lg:content-center lg:col-span-3 sm:col-span-1">
                                            <div class="lg:relative lg:-left-20 gs_reveal">
                                                <div class="bg-white p-4 rounded m-2">
                                                    <p class="primary regular text-black">We are delighted to collaborate with IYKRA, as they have provided significant support for tasks at BRI, especially in Data Engineering. The expertise of IYKRA's talent has proven to be competitive and capable of easily adapting to our workflow.</p>
                                                </div>
                                                <div class="p-4 m-2 lg:mb-0 lg:pb-0 lg:relative lg:left-20">
                                                    <p class="primary regular"><b>Suyanto</b></p>
                                                    <p class="primary regular">Bank Rakyat Indonesia</p>
                                                    <p class="primary regular">Manager (PIC utama Data Engineer) - Data Research Analytics Team</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="flex-1 space-y-4">
                    <div class="grid gap-4">
                        <div class=" content-center space-y-2">
                            <h3 class="primary text-black gs_reveal gs_reveal_fromLeft">As Seen On</h3>
                        </div>
                    </div>
                </div>
            </div>
