 ...
 * Slug: iykra/corporate-training-page
 * Categories: corporate
 * Block Types: core/template-part/corporate-training-page
 * Description: Corporate Training page.
 *
 * @package WordPress
 * @subpackage IYKRA
 * @since IYKRA 1.0
            ...
            <div class="relative px-8 lg:px-14">
                <div class="">
                    <div class="w-full relative space-y-14">
                        ...
                        <div class="grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-x-14 space-y-4 md:space-y-0 lg:space-y-0">
                            <div class="content-start w-full rounded-lg sm:col-span-1 md:col-span-1 lg:col-span-2">
                                <img 
                                    class="object-cover w-full h-auto rounded-xl shadow-lg" 
                                    src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/corporate/iykra-category-1.png"
                                />
                            </div>
                        ...
                        <p class="divider gray"></p>
                        <div class="grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-x-8 space-y-4 md:space-y-0 lg:space-y-0">
                            <div class="content-start w-full rounded-lg sm:col-span-1 md:col-span-1 lg:col-span-2">
                                <img 
                                    class="object-cover w-full h-auto rounded-xl shadow-lg" 
                                    src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/corporate/iykra-category-2.png"
                                />
                            </div>
                            <div class="content-start w-full sm:col-span-1 md:col-span-1 lg:col-span-1">
    ...
    <div class="bg-white" id="section-dot">
        <div class="mx-auto sm:px-0 lg:px-14">
            <div class="px-8 py-8 lg:px-14 lg:py-14">
                                ...
                                <div class="col-span-1 lg:col-span-3 content-center text-left gs_reveal">
                                    <div class="content-center align-center justify-center w-full bg-3 rounded-xl">
                                        <img 
                                            ...
                                            src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/corporate/iykra-solution-1.png"
                                        />
                                    </div>
                                </div>
                            ...
                            <div class="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-5 bg-spectra-yellow p-8 rounded-xl">
                                ...
                                <div class="col-span-1 lg:col-span-3 content-center text-left gs_reveal">
                                    <div class="content-center align-center justify-center w-full bg-3 rounded-xl">
                                        <img 
                                            class="object-scale-down lg:object-cover h-96 mx-auto p-8" 
                                            src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/corporate/iykra-solution-2.png"
                                        />
                                    </div>
                                </div>
                                <div class="col-span-1 lg:col-span-2 content-start space-y-2 text-left gs_reveal">
                            ...
                            <div class="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-5 bg-spectra-yellow p-8 rounded-xl">
                                ...
                                <div class="col-span-1 lg:col-span-3 content-center text-left gs_reveal">
                                    <div class="content-center align-center justify-center w-full bg-3 rounded-xl">
                                        <img 
                                            class="object-scale-down lg:object-cover h-96 mx-auto p-8" 
                                            src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/corporate/iykra-solution-3.png"
                                        />
                                    </div>
                                </div>
                                <div class="col-span-1 lg:col-span-2 content-start space-y-2 text-left gs_reveal">
                ...
                <div class="flex items-end lg:justify-end justify-center lg:relative mr-0 lg:mr-8" style="margin-top: -2rem;">
                        ...
                        <div class="grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-10 gap-4">
                            <div class="flex flex-col justify-between w-full rounded-lg col-span-3 iykra-implement-card active p-4 border border-black">
                                ...
                                <div class="space-y-2 py-4 iykra-implement-content flex-grow pb-4">
                                    ...
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Traffic Flow Optimization</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Social Media Listening</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Public Sentiment Analytic</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Network Analysis</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Internal Risk Assessment</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Text Transformation</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Cash Management</p>
                                </div>
                                <div class="iykra-implement-status active"></div>
                            </div>
                            ...
                            <div class="flex flex-col justify-between w-full rounded-lg col-span-3 iykra-implement-card active p-4 border border-black">
                                ...
                                <div class="space-y-2 py-4 iykra-implement-content hidden flex-grow pb-4">
                                    ...
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Network Anomaly Detection</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Customer Value Management</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Churn Prediction</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Analysis of Network Usage</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Customer Retention</p>
                                </div>
                                <div class="iykra-implement-status"></div>
                            </div>
                            ...
                            <div class="flex flex-col justify-between w-full rounded-lg col-span-3 iykra-implement-card active p-4 border border-black">
                                ...
                                <div class="space-y-2 py-4 iykra-implement-content hidden flex-grow pb-4">
                                    ...
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Ads Optimization</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Customer 360</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Logistic Optimization</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Clickstream Analysis</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Equipment Monitoring</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Influencer & Analysis</p>
                                </div>
                                <div class="iykra-implement-status"></div>
                            </div>
                            ...
                            <div class="flex flex-col justify-between w-full rounded-lg col-span-3 iykra-implement-card active p-4 border border-black">
                                ...
                                <div class="space-y-2 py-4 iykra-implement-content hidden flex-grow pb-4">
                                    ...
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Optimization</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Competition Analysis</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">New Product Research</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Legal Discovery</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Healthcare Outcomes</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Vendor Management</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Pricing Optimization</p>
                                </div>
                                <div class="iykra-implement-status"></div>
                            </div>
                            ...
                            <div class="flex flex-col justify-between w-full rounded-lg col-span-3 iykra-implement-card active p-4 border border-black">
                                ...
                                <div class="space-y-2 py-4 iykra-implement-content hidden flex-grow pb-4">
                                    ...
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Customer Segmentation</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Fraud Detections</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Credit Assessment</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Competition Analysis</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Cross-up Sell</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Churn Mitigation</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Loyalty Promotion Analysis</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Web Apps Optimization</p>
                                </div>
                                <div class="iykra-implement-status"></div>
                            </div>
                            ...
                            <div class="flex flex-col justify-between w-full rounded-lg col-span-3 iykra-implement-card active p-4 border border-black">
                                ...
                                <div class="space-y-2 py-4 iykra-implement-content hidden flex-grow pb-4">
                                    ...
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Inventory Management</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Demand Forecasting</p>
                                </div>
                                <div class="iykra-implement-status"></div>
                            ...
                            <div class="flex flex-col justify-between w-full rounded-lg col-span-3 iykra-implement-card active p-4 border border-black">
                                ...
                                <div class="space-y-2 py-4 iykra-implement-content hidden flex-grow pb-4">
                                    ...
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Wildfires Monitoring System</p>
                                </div>
                                <div class="iykra-implement-status"></div>
                            </div>
                            ...
                            <div class="flex flex-col justify-between w-full rounded-lg col-span-3 iykra-implement-card active p-4 border border-black">
                                ...
                                <div class="space-y-2 py-4 iykra-implement-content hidden flex-grow pb-4">
                                    ...
                                    <p class="iykra-gs text-left text-sm">Predictive Maintenance</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Operation Anomaly Detection</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Pipe Leak Detection</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Natural Resource Exploration</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Pump and Compressor Health Monitoring</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Weather Forecasting</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Mining Cost Optimization</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">Vendor Fraud Management</p>
                                    <p class="divider gray"></p>
                                    <p class="iykra-gs text-left text-sm">PR Media Analytics</p>
                                </div>
                                <div class="iykra-implement-status"></div>
                            </div>
                        </div>
