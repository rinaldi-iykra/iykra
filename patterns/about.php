                ...
                <div class="flex-1 space-y-4 bg-3">
                    <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                        <div class="lg:p-14 p-4 content-center space-y-2 gs_reveal gs_reveal_fromLeft lg:my-14">
                            <h1 class="primary">About</h1>
                            <p class="primary color-muted-2 pb-4">IYKRA specializes as a data consulting firm, concentrating on corporate training, managed services, project implementation, data engineering bootcamps, and fostering data communities</p>
                        </div>
            ...
            <div>
                <div class="grid grid-cols-4 space-y-4">
                    <div class="lg:col-span-3 col-span-4 lg:pr-4 content-center space-y-2 gs_reveal gs_reveal_fromLeft">
                        <h3 class="primary text-black">Who We Are</h3>
                        <div class="space-y-4">
                            <p class="primary regular text-black">IYKRA’s vision is building an Artificial Intelligence (AI) Talent Ecosystem in Indonesia. IYKRA help corporates and public or individual learners answer their business questions by building better use of data.</p>
                            <p class="primary regular text-black">Our learners will be taught by our qualified industry experts and be maintained with the fluency of business, data, and technology skill sets in both of our classroom and online class platform.</p>
                            <p class="primary regular text-black">Upon learning, we help learners create working channel to our hiring partners and keep them up to date by maintaining the network via community.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex-1 space-y-4">
                    <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                        <div class="content-center gs_reveal gs_reveal_fromLeft">
                            <img class="object-cover" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/about/iykra-about-2.png"/>
                        </div>

                        <div class="p-4 content-center space-y-4 gs_reveal gs_reveal_fromRight lg:my-14">
                            <h3 class="primary">Our Values</h3>
                            <p class="primary regular color-harvest-gold pb-4">CRAFTED by IYKRA</p>
