<?php
/**
 * Title: Event BerandAI
 * Slug: iykra/event-berandai
 * Categories: event
 * Block Types: core/template-part/event-berandai-page
 * Description: Event BerandAI page.
 *
 * @package WordPress
 * @subpackage IYKRA
 * @since IYKRA 1.0
                ...
                <div class="">
                    <div class="w-full relative">
                        ...
                        <div class="flex grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-5 mt-4">
                            ...
                            <div class="content-start py-4 lg:py-0 lg:px-8">
                            </div>
                            ...
                            <div class="content-start w-full sm:col-span-1 md:col-span-2 lg:col-span-3 py-4 lg:py-0 lg:px-8 space-y-8 gs_reveal">
                                ...
                                <div class="grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-y-4 gap-x-8">
                                    ...
                                    <div class="sm:col-span-1 md:col-span-2 lg:col-span-2">
                                        <p class="iykra-gs text-xl">Perusahaan dapat menampilkan studi kasus AI, berbagi insight, dan menunjukkan solusi AI mereka.</p>
                                    </div>
                                </div>
                                <p class="divider gray"></p>
                                <div class="grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-y-4 gap-x-8">
                                    ...
                                    <div class="sm:col-span-1 md:col-span-2 lg:col-span-2">
                                        <p class="iykra-gs text-xl">Bertemu dengan AI engineers siap kerja dari program pelatihan berbasis industri.</p>
                                    </div>
                                </div>
                                <p class="divider gray"></p>
                                <div class="grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-y-4 gap-x-8">
                                    ...
                                    <div class="sm:col-span-1 md:col-span-2 lg:col-span-2">
                                        <p class="iykra-gs text-xl">Sesi wawasan dari pemimpin bisnis, AI experts, dan inovator teknologi.</p>
                                    </div>
                                </div>
                                <p class="divider gray"></p>
                                <div class="grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-y-4 gap-x-8">
                                    ...
                                    <div class="sm:col-span-1 md:col-span-2 lg:col-span-2">
                                        <p class="iykra-gs text-xl">Membangun relasi dengan perusahaan lain, investor, dan komunitas AI.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-x-4 space-y-4 md:space-y-0 lg:space-y-0 gs_reveal">
                            <div class="flex flex-col justify-between w-full space-y-4 sm:col-span-1 md:col-span-1 lg:col-span-2 bg-footer text-white p-8 rounded-xl h-full shadow-lg">
                                <div class="space-y-4">
                                    ...
                                    <p class="iykra-gs text-lg">BerandAI membuka peluang bagi perusahaan yang ingin:</p>
                                    <p class="divider white"></p>
                                    <p class="iykra-gs text-lg">Menampilkan solusi AI atau studi kasus bisnis di depan audiens industri.</p>
                                    <p class="divider white"></p>
                                    <p class="iykra-gs text-lg">Membangun kemitraan strategis dengan praktisi AI, startup, dan enterprise lainnya.</p>
                                    <p class="divider white"></p>
                            ...
                            <div class="content-start w-full space-y-4 sm:col-span-1 md:col-span-1 lg:col-span-2 space-y-4 bg-spectra-yellow p-8 rounded-xl shadow-lg">
                                ...
                                <p class="iykra-gs text-lg">Ingin terlibat langsung dalam proyek AI nyata? Bergabunglah dengan program AI Engineering Fellowship, program pelatihan berbasis proyek yang membekali peserta dengan keterampilan siap kerja di bidang AI.</p>
                                <p class="iykra-gs text-lg">Sebagai peserta AI Fellowship, Anda akan mendapatkan:</p>
                                <p class="divider black"></p>
                                <p class="iykra-gs text-lg">Pengalaman hands-on dalam mengembangkan solusi AI untuk perusahaan.</p>
                                <p class="divider black"></p>
                                <p class="iykra-gs text-lg">Kesempatan untuk mempresentasikan proyek AI Anda di BerandAI.</p>
                                <p class="divider black"></p>
                            ...
                            <div class="content-start w-full space-y-4 sm:col-span-1 md:col-span-1 lg:col-span-2 space-y-4 bg-gray p-8 rounded-xl shadow-lg">
                                ...
                                <p class="iykra-gs text-lg">BerandAI terbuka untuk profesional, penggiat AI, dan bisnis yang ingin memahami lebih jauh penerapan AI di industri. Akan ada 3 edisi BerandAI dengan tema berbeda yang berlangsung hingga awal 2026.</p>
                                <p class="iykra-gs text-lg">Jadwal BerandAI:</p>
                                <p class="divider black"></p>
                                <p class="iykra-gs text-lg"><b class="iykra-sg">[BerandAI 2]</b> - Healthcare<br/>(Sabtu, 12 Juli 2025)</p>
                                <p class="divider black"></p>
                                <p class="iykra-gs text-lg"><b class="iykra-sg">[BerandAI 3]</b> - Finance<br/>(Sabtu, 18 Oktober 2025)</p>
                                <p class="divider black"></p>
                                <p class="iykra-gs text-lg"><b class="iykra-sg">[BerandAI 4]</b> - BerandAI Otomotif<br/>(Sabtu, 31 Januari 2026)</p>
                                <p class="divider black"></p>
                                <p class="iykra-gs text-lg">Stay tuned untuk detail acara dan pendaftaran!</p>
                            </div>
                        </div>
                    </div>
                </div>
