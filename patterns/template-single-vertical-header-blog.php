 ...
 * Slug: iykra/template-single-vertical-header-blog
		...
		<main class="wp-block-group">
			...
			<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--50)">
				...
				<div class="wp-block-columns">
					...
					<div class="wp-block-column" style="padding-bottom:var(--wp--preset--spacing--80);flex-basis:75%">
			...
			<!-- /wp:group -->
			<!-- wp:group {"ariaLabel":"<?php esc_attr_e( 'Post navigation', 'iykra' ); ?>","tagName":"nav","align":"full","style":{"border":{"top":{"color":"var:preset|color|accent-6","width":"1px"}},"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"},"blockGap":"var:preset|spacing|40"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
			<nav class="wp-block-group alignfull" aria-label="<?php esc_attr_e( 'Post navigation', 'iykra' ); ?>" style="border-top-color:var(--wp--preset--color--accent-6);border-top-width:1px;padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)">
