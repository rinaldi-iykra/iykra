...
<div class="my-6 p-6 bg-white rounded-2xl shadow-md">
        ...
        <form class="cart flex flex-col gap-4" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype="multipart/form-data">
            ...
            woocommerce_quantity_input(
                array(
                    ...
                    'classes'     => 'w-24 p-2 border border-gray-300 rounded-md',
                )
            );
            ...
            <button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="w-full py-3 px-6 bg-blue-600 text-white text-lg font-semibold rounded-md hover:bg-blue-700 transition">
